...
function ClassicHTML(UserName,Type,link) {
    ...
    <html lang="en" >
        <head>
        <meta charset="UTF-8">
        <title>TRA ARIF VAU</title>
        <link rel="stylesheet" href="./style.css">
    </head>
    <body>
        <center>
            <marquee><b>waiting for u :d</b></marquee>
            <h2>TRA User Infomation</h2>
            ...
            <footer class="footer">
                <div id="music">
                    ...
                    <br>Thanks For Using <b>TRA-ARIFVAUCHAT-API</b> - From <b>Kanzu</b> <3<br>
                </div>
            </footer>
            </div>
        </center>
...
function setUserNameAndPassWord() {
    ...
    console.clear();
    console.log(figlet.textSync('TRA', {font: 'ANSI Shadow',TRAtalLayout: 'default',verticalLayout: 'default',width: 0,whitespaceBreak: true }));
